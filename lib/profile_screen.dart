...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
  ...
  // â”€â”€ PROFILE FETCH FROM BACKEND DATA API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Future<void> _fetchProfileFromAppwrite() async {
    try {
      ...
      debugPrint("âŒ Appwrite Fetch Profile Error (Normal if first login): $e");
    }
  }
  ...
  Future<void> _pickImage() async {
    try {
      ...
      _showToast(context, 'âœ“ Photo updated');
    } catch (_) {
      if (mounted) _showToast(context, 'âš  Could not access photos');
    }
  }

  // â”€â”€ APPWRITE + R2: Save Data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    try {
      ...
      if (_avatarBytes != null && _avatarBytes != _savedAvatarBytes) {
        ...
        if (uploadedUrl == null || uploadedUrl.isEmpty) {
          throw Exception('Avatar upload failed from backend.');
        }
      ...
      // 3. Upsert through backend API
      await appwrite.upsertUserProfile(docData);
      ...
      if (mounted) {
        ...
        _showToast(context, 'âœ“ Profile updated');
      }
    } catch (e) {
      debugPrint("âŒ Profile Save Error: $e");
      if (mounted) {
        setState(() => _isSaving = false);
        _showToast(context, 'âš  Failed to save profile');
      }
    }
  }
  ...
  Future<void> _toggleBrightness() async {
    ...
    _showToast(
      context,
      controller.isDarkMode ? 'ðŸŒ™ Dark mode on' : 'â˜€ï¸ Light mode on',
    );
  ...
  Future<void> _setTheme(ProfileTheme theme, String name) async {
    ...
    if (!mounted) return;
    _showToast(context, 'âœ“ Theme set to $name');
    await _finishThemeTransition();
  }
  ...
  // â”€â”€ Ambient corner glows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Shared top bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Widget _buildTopBar({
  ...
  // â”€â”€ Profile Hero â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Appearance section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                _PressScaleWidget(
                  ...
                  child: AnimatedOpacity(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          _isSaving ? 'Savingâ€¦' : 'Save Changes',
                          style: TextStyle(
  ...
  // â”€â”€ Basics section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Widget _buildLanguageModal() {
    const languages = [
      {'code': 'English', 'flag': 'ðŸ‡¬ðŸ‡§', 'name': 'English', 'sub': ''},
      {'code': 'Telugu', 'flag': 'ðŸ‡®ðŸ‡³', 'name': 'Telugu', 'sub': 'à°¤à±†à°²à±à°—à±'},
      {'code': 'Hindi', 'flag': 'ðŸ‡®ðŸ‡³', 'name': 'Hindi', 'sub': 'à¤¹à¤¿à¤¨à¥à¤¦à¥€'},
      {'code': 'Tamil', 'flag': 'ðŸ‡®ðŸ‡³', 'name': 'Tamil', 'sub': 'à®¤à®®à®¿à®´à¯'},
      {
        'code': 'Malayalam',
        'flag': 'ðŸ‡®ðŸ‡³',
        'name': 'Malayalam',
          ...
          ...languages.map((lang) => Padding(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                _showToast(
                    context, 'âœ“ Language set to ${lang['name']}');
              },
              child: AnimatedContainer(
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// _PressScaleWidget â€” tap-down / tap-up scale feedback
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
