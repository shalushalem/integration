...
const bool kForceDebugBootScreen = false;
      ...
      child: Consumer<ThemeController>(
        builder: (context, controller, child) {
          ...
          return MaterialApp(
            ...
            home: kForceDebugBootScreen ? const _DebugBootScreen() : const AuthWrapper(),
...
class _DebugBootScreen extends StatelessWidget {
  const _DebugBootScreen();
      ...
      body: Center(
        child: Column(
          ...
          children: const [
            ...
            SizedBox(height: 8),
            Text(
              'If you can see this, the app is running.',
              style: TextStyle(color: Colors.white, fontSize: 16),
            ),
          ],
        ),
