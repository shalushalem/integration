...
class SignInScreen extends StatelessWidget {
  ...
  void _goToEmailAuth(BuildContext context) {
    debugPrint("🚀 GOING TO EMAIL AUTH...");
  ...
  Future<void> _handleGoogleLogin(BuildContext context) async {
    ...
    try {
      ...
      if (success && context.mounted) {
        debugPrint("✅ LOGIN SUCCESS! Moving to main app...");
        Navigator.of(context).pushNamedAndRemoveUntil(
          AppRoutes.main,
          (route) => false,
        );
      } else if (context.mounted) {
        debugPrint("❌ LOGIN FAILED OR CANCELED.");
    ...
    return _GlassCard(
      child: Column(
        ...
        children: [
          ...
          const _Divider(),
          GestureDetector(
            behavior: HitTestBehavior.opaque, // <--- Crucial Fix!
            onTap: onEmailTap,
            child: const Padding(
              padding: EdgeInsets.all(8.0), // Adds a larger invisible tap area
              child: _HoverOpacity(
