...
class _AddItemModalState extends State<_AddItemModal>
  ...
  Future<void> _saveAndUpload() async {
    ...
    try {
      ...
      final newDoc = await appwrite.createWardrobeItem(documentData);
...
class _FilterBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final chips = [
      ...
      _ChipData(
          label: 'Outerwear',
          icon: _iconForCategory('Outerwear'),
      ...
      _ChipData(
          label: 'Footwear',
          icon: _iconForCategory('Footwear'),
      ...
      _ChipData(
          label: 'Accessories',
          icon: _iconForCategory('Accessories'),
      ...
      _ChipData(
          label: 'Indian Wear',
          icon: _iconForCategory('Indian Wear'),
          activeBg: t.accent.tertiary.withValues(alpha: 0.24),
          activeBorder: t.accent.tertiary,
          activeShadow: t.accent.tertiary.withValues(alpha: 0.20),
          inactiveBg: t.accent.tertiary.withValues(alpha: 0.10),
          inactiveBorder: t.accent.tertiary.withValues(alpha: 0.28),
          inactiveText: t.accent.tertiary,
          activeText: t.textPrimary),
      _ChipData(
          label: 'Bags',
          icon: _iconForCategory('Bags'),
      ...
      _ChipData(
          label: 'Skincare',
          icon: _iconForCategory('Skincare'),
